...
if __name__=="__main__":
    ...
    robot_id = pb.loadURDF("2dof_planar_robot.urdf", basePosition=[0,0,0], useFixedBase=True)
    ...
    pb.createMultiBody(baseMass=0, baseCollisionShapeIndex=sphere_collision_shape, baseVisualShapeIndex=sphere_visual_shape, basePosition=link2_position)
